    ...
    <div class="card-body">
        ...
        <form action="{{url('/medicos/'. $doctor->id)}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="Nombre del médico" value="{{ old('name', $doctor->name)}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" placeholder="Correo electrónico" value="{{ old('email', $doctor->email)}}">
            </div>
            <div class="form-group">
                <label for="cedula">Cédula:</label>
                <input type="number" name="cedula" class="form-control" placeholder="Cédula" value="{{ old('cedula', $doctor->cedula)}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="phone" class="form-control" placeholder="Teléfono / Móvil" value="{{ old('phone', $doctor->phone)}}">
            </div>
            <div class="form-group">
